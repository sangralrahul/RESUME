      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{
            ...
            <span style={{ color: 'rgba(212,212,212,0.35)', margin: '0 6px' }}>=</span>
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            {[
              ...
              <a key={l.href} href={l.href} target="_blank" rel="noopener noreferrer"
                className="link-draw"
                style={{ fontFamily: 'JetBrains Mono', fontSize: '0.72rem', color: 'rgba(212,212,212,0.25)', textDecoration: 'none', transition: 'color 0.2s ease' }}
                onMouseEnter={(e) => { e.currentTarget.style.color = '#569CD6'; }}
                onMouseLeave={(e) => { e.currentTarget.style.color = 'rgba(212,212,212,0.25)'; }}
              >
                {l.label} ↗
              </a>
            ))}
          ...
          <span style={{ fontFamily: 'JetBrains Mono', fontSize: '0.62rem', color: 'rgba(212,212,212,0.15)' }}>
