      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 mb-12">
          <a
            ...
            className="w-full sm:w-auto bg-[#1A1A28] border border-[rgba(124,58,237,0.25)] hover:border-[#A855F7] hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:-translate-y-1 transition-all rounded-xl px-6 py-4 flex items-center justify-center space-x-3 text-white font-['DM_Sans']"
          >
